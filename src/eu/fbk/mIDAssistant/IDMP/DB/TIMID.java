...
public class TIMID implements IDMP {
    ...
    public String DiscoverURL() {
        return discoverURL = "https://idp.tim.it/.well-known/openid-configuration";
    }

    @Override
    public String AuthorizationURL() {
        return authorizationURL = "https://gov.tim.it/auth";
    }

    @Override
    public String TokenURL() {
        return tokenURL = "https://gov.tim.it/token";
    }

    @Override
    public String UserInfoURL() {
        return userInfoURL ="https://gov.tim.it/v1/userinfo";
    }
